...
LibraryBookListActions::LibraryBookListActions( QWidget* parent ) :
...
LibraryBookListActions::~LibraryBookListActions()
{}

void LibraryBookListActions::paintEvent(QPaintEvent* )
{
    QStyleOption opt;
    opt.init(this);
    QPainter p(this);
...
void LibraryBookListActions::setButtonsState( BookInfo::readStateEnum state)
{
    switch(state)
    {
