...
#ifndef MINIATUREVIEWLANDSCAPE_H
#define MINIATUREVIEWLANDSCAPE_H

#include "ui_MiniatureViewLandscape.h"

class MiniatureViewLandscape :  public QWidget
                               ,protected Ui::MiniatureViewLandscape
{
    Q_OBJECT
public:
    MiniatureViewLandscape(QWidget*);
